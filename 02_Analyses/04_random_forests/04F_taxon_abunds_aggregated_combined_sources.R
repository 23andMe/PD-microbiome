# random forests taxonomic abundances aggregated combined sources
...
taxon.agg.cmb.rf.mods.file <- file.path(
  dirs$saved,
  "randForest_taxon_aggregated_combined_list.rds"
)
taxon.agg.cmb.rf.mods <- redo.if(
  redo.var,
  taxon.agg.cmb.rf.mods.file,
